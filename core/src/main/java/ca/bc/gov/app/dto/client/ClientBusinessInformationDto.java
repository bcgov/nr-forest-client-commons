...
@With
public record ClientBusinessInformationDto(String registrationNumber, String businessName,
                                           String businessType, String clientType,
                                           String goodStandingInd, String legalType,
                                           LocalDate birthdate, String district,
                                           String workSafeBcNumber, String doingBusinessAs,
                                           String clientAcronym, String firstName,
                                           String middleName, String lastName, String notes,
